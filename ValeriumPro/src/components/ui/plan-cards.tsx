...
const proFeatures: PlanFeature[] = [
  ...
  { label: "Unlimited customers" },
  { label: "Invoicing + analytics" },
  { label: "Document vault" },
  { label: "AI assistant" },
  { label: "Priority support" },
]
function getPlanPricing(region: string) {
  const isEU = region === "EU" || region?.startsWith("EU")
  return {
    currency: isEU ? "EUR" : "USD",
    symbol: isEU ? "€" : "$",
    starter: { monthly: isEU ? 27 : 29, annual: isEU ? 17 : 19, yearly: isEU ? 17 : 19 },
    pro: { monthly: isEU ? 74 : 79, annual: isEU ? 55 : 59, yearly: isEU ? 55 : 59 },
  }
}
